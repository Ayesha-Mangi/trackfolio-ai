...
export const LoginPage: React.FC = () => {
  const { user, loading, login, signInWithGoogle, loginAsGuest, error, clearError } = useAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Sign in to manage your applications and deadlines
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none">
          ...
          <button
            ...
            className="w-full mb-4 py-3 px-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/80 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-sm transition-all shadow-sm flex items-center justify-center gap-3"
          >
            {isGoogleSubmitting ? (
          ...
          <button
            type="button"
            onClick={handleGuestLogin}
            className="w-full mb-6 py-2.5 px-4 rounded-xl border border-dashed border-blue-300 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-950/30 hover:bg-blue-100/60 dark:hover:bg-blue-900/40 text-blue-700 dark:text-blue-300 font-semibold text-xs transition-all flex items-center justify-center gap-2"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold text-sm transition-all shadow-md shadow-blue-500/25 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
            <p className="text-xs text-slate-600 dark:text-slate-400">
              Don't have a TrackFolio AI account yet?{' '}
              <Link
                to="/signup"
